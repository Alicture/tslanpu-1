...
//本地用
    ...
    var pageCode; //当前页
  	...
  	function _myonclick(page, name, category, address, department, fddelegate, zzcode, depart){
  		...
  		$.ajax({
  			url:"http://localhost:8080/tslanpu/QueryServlet",
  			...
  			success:function(jsonData){
  				...
  				if(category == "食品生产企业"){
  						if(jsonData.pb.datas.length == 0){
  							htmlStr = "";
  							htmlStr += "<tr align='center'><td><b>您查找的信息为空<a href='http://localhost:8080/tslanpu/ProductionFormServlet'>" +
  									   "现在去添加</a></b></td></tr>";
  						}else{
  							var htmlStr = "";
  						...
  						if(jsonData.pb.datas.length == 0){
							htmlStr = "";
							htmlStr += "<tr align='center'><td><b>您查找的信息为空<a href='http://localhost:8080/tslanpu/CriculateFormServlet'>" +
									   "现在去添加</a></b></td></tr>";
						}else{
							var htmlStr = "";
						...
						for(var i = 0; i < jsonData.pb.datas.length;){
	  					...
	  					if(jsonData.pb.datas.length == 0){
							htmlStr = "";
							htmlStr += "<tr align='center'><td><b>您查找的信息为空<a href='http://localhost:8080/tslanpu/FoodFormServlet'>" +
									   "现在去添加</a></b></td></tr>";
						}else{
							var htmlStr = "";
					...
					for(var i = 0; i < jsonData.pb.datas.length;){
  					...
  					if(jsonData.pb.datas.length == 0){
						htmlStr = "";
						htmlStr += "<tr align='center'><td><b>您查找的信息为空<a href='http://localhost:8080/tslanpu/pages/tables/health/health.jsp'>" +
								   "现在去添加</a></b></td></tr>";
					}else{
						var htmlStr = "";
  					...
  					if(jsonData.pb.datas.length == 0){
						htmlStr = "";
						htmlStr += "<tr align='center'><td><b>您查找的信息为空<a href='http://localhost:8080/tslanpu/pages/tables/medical/medical.jsp'>" +
								   "现在去添加</a></b></td></tr>";
					}else{
						var htmlStr = "";
  					...
  					if(jsonData.pb.datas.length == 0){
						htmlStr = "";
						htmlStr += "<tr align='center'><td><b>您查找的信息为空<a href='http://localhost:8080/tslanpu/pages/tables/industry/industry.jsp'>" +
								   "现在去添加</a></b></td></tr>";
					}else{
						var htmlStr = "";
  					...
  					if(jsonData.pb.datas.length == 0){
						htmlStr = "";
						htmlStr += "<tr align='center'><td><b>您查找的信息为空<a href='http://localhost:8080/tslanpu/pages/tables/wine/wine.jsp'>" +
								   "现在去添加</a></b></td></tr>";
					}else{
						var htmlStr = "";
  					...
  					if(jsonData.pb.datas.length == 0){
						htmlStr = "";
						htmlStr += "<tr align='center'><td><b>您查找的信息为空<a href='http://localhost:8080/tslanpu/pages/tables/drug/drug.jsp'>" +
								   "现在去添加</a></b></td></tr>";
					}else{
						var htmlStr = "";
  					...
  					if(jsonData.pb.datas.length == 0){
						htmlStr = "";
						htmlStr += "<tr align='center'><td><b>您查找的信息为空<a href='http://localhost:8080/tslanpu/pages/tables/cosmetic/cosmetic.jsp'>" +
								   "现在去添加</a></b></td></tr>";
					}else{
						var htmlStr = "";
  					...
  					if(jsonData.pb.datas.length == 0){
						htmlStr = "";
						htmlStr += "<tr align='center'><td><b>您查找的信息为空<a href='http://localhost:8080/tslanpu/pages/tables/usemed/usemed.jsp'>" +
								   "现在去添加</a></b></td></tr>";
					}else{
						var htmlStr = "";
