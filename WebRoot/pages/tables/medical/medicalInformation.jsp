  ...
  <head>
    ...
    <script type="text/javascript">
    	...
    	function onclick1(id){
    		...
    		if(sub == true){
	   			$.ajax({
					url:"${pageContext.request.contextPath }/MedicalServlet",
					type: "POST",
          ...
          <div class="row" style="text-align:center">
            <div class="col-xs-12">
              <div class="box">
                ...
                <!-- 打印 -->
                <form id="printForm" action="${pageContext.request.contextPath }/MedicalServlet" method="post">
                	<input type="hidden" name="method" value="print">
                	<input type="hidden" name="idU" value="${medical.id }">
                </form>
                
                <form action="${pageContext.request.contextPath }/MedicalServlet" method="post" onsubmit="return sumbit_sure()" >
