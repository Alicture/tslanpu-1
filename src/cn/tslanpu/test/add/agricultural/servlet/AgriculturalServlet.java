...
public class AgriculturalServlet extends BaseServlet {
	...
	public void add(HttpServletRequest request, HttpServletResponse response)
		...
		Agricultural agricultural = setBean(request, response);
			...
			request.getRequestDispatcher("/pages/tables/agricultural/agricultural.jsp").forward(request, response);
	}
	...
	public void infor(HttpServletRequest request, HttpServletResponse response)
			...
			request.getRequestDispatcher("/pages/tables/agricultural/agriculturalInformation.jsp").forward(request, response);
	}
...
//			//回显
	...
	public void print(HttpServletRequest request, HttpServletResponse response)
			...
			request.setAttribute("agricultural", agricultural);
			request.getRequestDispatcher("/pages/tables/agricultural/downloadAgriculturalInfo.jsp").forward(request, response);
	}
