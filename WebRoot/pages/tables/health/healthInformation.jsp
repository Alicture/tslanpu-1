  ...
  <head>
    ...
    <script type="text/javascript">
    	...
    	function onclick1(id){
    		...
    		if(sub == true){
	   			$.ajax({
					url:"${pageContext.request.contextPath }/HealthServlet",
					type: "POST",
          ...
          <div class="row" style="text-align:center">
            <div class="col-xs-12">
              <div class="box">
                ...
                <!-- 打印 -->
                <form id="printForm" action="${pageContext.request.contextPath }/HealthServlet" method="post">
                	<input type="hidden" name="method" value="print">
                	<input type="hidden" name="id" value="${health.id }">
                </form>
                
                <form action="${pageContext.request.contextPath }/HealthServlet" method="post" onsubmit="return sumbit_sure()" >
